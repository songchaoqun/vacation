...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	...
	<div id="main">
		<div id="tabhead" class="tab-head">
			<h2 id="tab1" class="selected" name="tab" style="align-content: center">付 款</h2>
		</div>
		<form name=alipayment action="<%=request.getContextPath() %>/alipay.trade.page.pay.jsp" method=post
			target="_blank">
			<div id="body1" class="show" name="divcontent">
				<dl class="content">
					...
					<dd id="btn-dd">
						...
						</span> <span class="note-help">如果您点击“付款”按钮，即表示您同意该次的执行操作。概不退款！！</span>
					</dd>
				</dl>
			</div>
		</form>
