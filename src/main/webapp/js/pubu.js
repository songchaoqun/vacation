...
$(window).load(function(){
    var data = [{"src":"<%=request.getContextPath() %>/images/3.jpg"},{"src":"<%=request.getContextPath() %>/images/4.jpg"},{"src":"<%=request.getContextPath() %>/images/5.jpg"},{"src":"<%=request.getContextPath() %>/images/6.jpg"},{"src":"<%=request.getContextPath() %>/images/7.jpg"},{"src":"<%=request.getContextPath() %>/images/8.jpg"},{"src":"<%=request.getContextPath() %>/images/9.jpg"},{"src":"<%=request.getContextPath() %>/images/10.jpg"}];
    PBL("#pubu",".box",2);
